...
```text
week-17-parametrizacion_y_marks_con_pytest/
|-- README.md
...
|---|---|
| [Semana 16 - Fundamentos con pytest](../week-16-fundamentos_con_pytest/README.md) | [Semana 18 - Mocking en Python con unittest.mock y pytest-mock](../week-18-mocking_con_unittest_mock_y_pytest_mock/README.md) |
