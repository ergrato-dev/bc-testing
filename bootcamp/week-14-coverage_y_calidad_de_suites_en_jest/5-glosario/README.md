# Glosario Semana 14 - Coverage y Calidad de Suites

## B

- **branch coverage**: porcentaje de ramas condicionales ejecutadas por los tests.
...
- **test fragility**: sensibilidad excesiva de una prueba a cambios no relevantes.
- **test signal**: capacidad del test para indicar fallos reales con poco ruido.
